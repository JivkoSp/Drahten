...
namespace PrivateHistoryService.Tests.EndToEnd.Sync
{
    public class RemoveSearchedTopicDataTests : BaseSyncIntegrationTest
    {
        ...
        {
            var searchedTopicsResponse = await Get($"/privatehistory-service/users/{userId}/searched-topics/");
        ...
        public async Task Remove_Searched_TopicData_Endpoint_Should_Return_Http_Status_Code_NoContent()
        {
            ...
            //ACT
            var response = await Delete($"/privatehistory-service/users/{command.UserId}/searched-topics/{command.SearchedTopicDataId}");
        ...
        public async Task Remove_Searched_TopicData_Endpoint_Should_Remove_SearchedTopicData_From_The_Database()
        {
            ...
            await Delete($"/privatehistory-service/users/{command.UserId}/searched-topics/{command.SearchedTopicDataId}");

            //ACT
            var response = await Get($"/privatehistory-service/users/{command.UserId}/searched-topics/");
