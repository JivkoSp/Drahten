    ...
    public class AddViewedUserTests : BaseSyncIntegrationTest
    {
        ...
        public async Task Add_Viewed_User_Endpoint_Should_Return_Http_Status_Code_Created()
        {
            ...
            var response = await Post(command,
                $"/privatehistory-service/users/{command.ViewerUserId}/viewed-users/{command.ViewedUserId}");
            ...
            response.Headers.Location.ToString()
                .ShouldBe($"/privatehistory-service/users/{command.ViewerUserId}/viewed-users/{command.ViewedUserId}");
        }
        ...
        public async Task Add_Viewed_User_Endpoint_Should_Add_ViewedUser_To_The_Database()
        {
            ...
            var viewedUsersResponse = await Get($"/privatehistory-service/users/{command.ViewerUserId}/viewed-users/");
