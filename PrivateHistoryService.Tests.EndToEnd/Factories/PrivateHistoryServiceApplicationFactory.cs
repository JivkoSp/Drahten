...
using PrivateHistoryService.Tests.EndToEnd.Extensions;
using Testcontainers.PostgreSql;
using Xunit;

namespace PrivateHistoryService.Tests.EndToEnd.Factories
{
    public sealed class PrivateHistoryServiceApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
    {
        private readonly PostgreSqlContainer _dbContainer = new PostgreSqlBuilder()
                ...
                .WithDatabase("PrivateHistoryServiceDb")
                .WithUsername("PrivateHistoryServiceAdmin")
