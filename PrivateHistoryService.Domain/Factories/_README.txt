...
* Flexibility and Extensibility:
	As the application evolves, it might introduce new types of objects (e.g., different user types). The factory pattern allows to add new concrete 
...
* Method: The Create method in the interface accepts parameters (In the current case one parameter) necessary for constructing an instance of the User entity.
...
* Create Method: The Create method accepts parameters (such as UserID) and returns a fully constructed User entity.