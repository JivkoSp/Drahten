...
using PublicHistoryService.Infrastructure.Extensions;
using PublicHistoryService.Infrastructure.Logging.Formatters;
using PublicHistoryService.Presentation.Middlewares;
using Serilog;
