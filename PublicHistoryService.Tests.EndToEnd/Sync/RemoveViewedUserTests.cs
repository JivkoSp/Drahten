...
namespace PublicHistoryService.Tests.EndToEnd.Sync
{
    public class RemoveViewedUserTests : BaseSyncIntegrationTest
    {
        ...
        {
            var viewedUsersResponse = await Get($"/publichistory-service/users/{userId}/viewed-users/");
        ...
        public async Task Remove_Viewed_User_Endpoint_Should_Return_Http_Status_Code_NoContent()
        {
            ...
            //ACT
            var response = await Delete($"/publichistory-service/users/{command.ViewerUserId}/viewed-users/{command.ViewedUserId}");
        ...
        public async Task Remove_Viewed_User_Endpoint_Should_Remove_ViewedUser_From_The_Database()
        {
            ...
            await Delete($"/publichistory-service/users/{command.ViewerUserId}/viewed-users/{command.ViewedUserId}");

            //ACT
            var response = await Get($"/publichistory-service/users/{command.ViewerUserId}/viewed-users/");
