...
namespace PublicHistoryService.Tests.EndToEnd.Sync
{
    public class RemoveViewedArticleTests : BaseSyncIntegrationTest
    {
        ...
        {
            var viewedArticlesResponse = await Get($"/publichistory-service/users/{userId}/viewed-articles/");
        ...
        public async Task Remove_Viewed_Article_Endpoint_Should_Return_Http_Status_Code_NoContent()
        {
            ...
            //ACT
            var response = await Delete($"/publichistory-service/users/{command.UserId}/viewed-articles/{command.ViewedArticleId}");
        ...
        public async Task Remove_Viewed_Article_Endpoint_Should_Remove_ViewedArticle_From_The_Database()
        {
            ...
            await Delete($"/publichistory-service/users/{command.UserId}/viewed-articles/{command.ViewedArticleId}");

            //ACT
            var response = await Get($"/publichistory-service/users/{command.UserId}/viewed-articles/");
