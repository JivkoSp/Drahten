...
namespace PrivateHistoryService.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20240616101910_Added SearchedDataAnswerContext property of type string in SearchedArticleDataReadModel")]
    partial class AddedSearchedDataAnswerContextpropertyoftypestringinSearchedArticleDataReadModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PrivateHistoryService.Infrastructure.EntityFramework.Models.SearchedArticleDataReadModel", b =>
                {
                    ...
                    b.Property<string>("SearchedDataAnswerContext")
                        .IsRequired()
                        .HasColumnType("text");
