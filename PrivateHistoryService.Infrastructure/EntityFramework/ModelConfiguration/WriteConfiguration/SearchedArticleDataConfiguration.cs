...
namespace PrivateHistoryService.Infrastructure.EntityFramework.ModelConfiguration.WriteConfiguration
{
    internal sealed class SearchedArticleDataConfiguration : IEntityTypeConfiguration<SearchedArticleData>
    {
        ...
        public void Configure(EntityTypeBuilder<SearchedArticleData> builder)
        {
            ...
            builder.Property(typeof(SearchedDataAnswer), "SearchedDataAnswer")
                .HasConversion(new EncryptedSearchedDataAnswerConverter(_encryptionProvider))
                .IsRequired();

            builder.Property(typeof(SearchedDataAnswerContext), "SearchedDataAnswerContext")
                .HasConversion(new EncryptedSearchedDataAnswerContextConverter(_encryptionProvider))
                .IsRequired();
