...
{
    internal sealed class DislikedArticleConfiguration : IEntityTypeConfiguration<DislikedArticle>
    {
        ...
        public void Configure(EntityTypeBuilder<DislikedArticle> builder)
        {
            //Table name
