...
---
The IArticleFactory interface defines the contract for creating instances of the Article entity. It serves as the blueprint for any concrete factory that 
produces articles. Key points:
* Purpose: The IArticleFactory interface abstracts the creation process, allowing clients to create instance of the Article entity without knowing the details.
* Method: The Create method in the interface accepts parameters necessary for constructing an instance of the Article entity.
		  Important: These parameters align with the Article entity constructor.
Responsibility: Concrete factories implementing this interface will provide specific logic for creating instances of the article entity,
				based on the input parameters.
---
The ArticleFactory class is an implementation of the IArticleFactory interface. It handles the actual creation of Article entities.
* Purpose: The ArticleFactory encapsulates the logic for creating Article entities.
* Constructor: The ArticleFactory class itself doesn’t have a constructor. Instead, it relies on the Create method.
* Create Method: The Create method accepts parameters (such as title, author, and content) and returns a fully constructed Article entity.
-------------------------
Similar to IArticleFactory the other interfaces define the contract for creating instances of other entity types or value objects.
-------------------------
