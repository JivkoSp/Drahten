...
{
    public class RemoveIssuedContactRequestTests : BaseSyncIntegrationTest
    {
        ...
        public RemoveIssuedContactRequestTests(UserServiceApplicationFactory factory) : base(factory)
        {
        }
        ...
        [Fact]
        public async Task Remove_Issued_ContactRequest_Endpoint_Should_Return_Http_Status_Code_NoContent()
        {
            //ARRANGE
            ...
            //ACT
            var response = await Delete($"/user-service/users/{addContactRequestCommand.IssuerUserId}/issued-contact-requests/{addContactRequestCommand.ReceiverUserId}");
        ...
        [Fact]
        public async Task Remove_Issued_ContactRequest_Endpoint_Should_Remove_ContactRequest_From_The_Database_For_Issuer()
        {
            //ARRANGE
            var addContactRequestCommand = await PrepareAddContactRequestCommandAsync();
            ...
            await Delete($"/user-service/users/{addContactRequestCommand.IssuerUserId}/issued-contact-requests/{addContactRequestCommand.ReceiverUserId}");
        ...
        [Fact]
        public async Task Remove_Issued_ContactRequest_Endpoint_Should_Remove_ContactRequest_From_The_Database_For_Receiver()
        {
            //ARRANGE
            var addContactRequestCommand = await PrepareAddContactRequestCommandAsync();
